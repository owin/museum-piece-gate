...
namespace Owin
{
    ...
    {        
        ...
        {
            return builder.UseType<CascadeMiddleware>(apps.AsEnumerable<AppFunc>());
        }
        
        public static IAppBuilder UseCascade(this IAppBuilder builder, params Action<IAppBuilder>[] apps)
        {
            return builder.UseType<CascadeMiddleware>(apps.Select(cfg => builder.BuildNew<AppFunc>(x => cfg(x))));
        }
    }
}
...
namespace Gate.Middleware
{
    ...
    public class CascadeMiddleware
    {
        ...
        public CascadeMiddleware(AppFunc fallback, IEnumerable<AppFunc> apps)
        {
            this.apps = apps;
