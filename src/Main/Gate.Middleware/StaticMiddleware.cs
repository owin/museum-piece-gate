...
namespace Owin
{
    ...
    public static class StaticExtensions
    {
        ...
        {
            return builder.UseFunc<AppFunc>(app => StaticMiddleware.Middleware(app, root, urls));
        }

        public static IAppBuilder UseStatic(this IAppBuilder builder, IEnumerable<string> urls)
        {
            return builder.UseFunc<AppFunc>(app => StaticMiddleware.Middleware(app, urls));
        }

        public static IAppBuilder UseStatic(this IAppBuilder builder, string root)
        {
            return builder.UseFunc<AppFunc>(app => StaticMiddleware.Middleware(app, root));
        }

        public static IAppBuilder UseStatic(this IAppBuilder builder)
        {
            return builder.UseFunc<AppFunc>(StaticMiddleware.Middleware);
        }
    }
...
namespace Gate.Middleware
{
    ...
    public class StaticMiddleware
    {
        ...
        public StaticMiddleware(AppFunc app, IEnumerable<string> urls)
            : this(app, null, urls)
        { }

        public StaticMiddleware(AppFunc app, string root = null, IEnumerable<string> urls = null)
        {
            this.app = app;
        ...
        {
            return new StaticMiddleware(app, root, urls).Invoke;
        }

        public static AppFunc Middleware(AppFunc app, string root)
        {
            return new StaticMiddleware(app, root).Invoke;
        }

        public static AppFunc Middleware(AppFunc app, IEnumerable<string> urls)
        {
            return new StaticMiddleware(app, urls).Invoke;
        }

        public static AppFunc Middleware(AppFunc app)
        {
            return new StaticMiddleware(app).Invoke;
        }
